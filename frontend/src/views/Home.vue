  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          <div class=”tag-row”>
            <span class=”orange-tag”>간결하고 범용적인 군중 지능 엔진</span>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // 즉시 Process 페이지로 이동 (새 프로젝트를 나타내는 특수 식별자 사용)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Space Grotesk를 주요 제목 글꼴로, JetBrains Mono를 코드/태그 글꼴로 사용
    index.html에서 해당 Google Fonts가 로드되었는지 확인
  */
  --font-mono: 'JetBrains Mono', monospace;
  --font-sans: 'Space Grotesk', 'Noto Sans KR', system-ui, sans-serif;
  --font-cn: 'Noto Sans KR', system-ui, sans-serif;
}
