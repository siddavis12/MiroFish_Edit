    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM이 문서 내용과 시뮬레이션 요구사항을 분석하여 현실 시드를 추출하고, 적절한 온톨로지 구조를 자동 생성
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            생성된 온톨로지를 기반으로 문서를 자동 청킹한 후 Zep을 호출하여 지식 그래프를 구축하고, 엔티티와 관계를 추출하며, 시계열 기억과 커뮤니티 요약을 형성
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">SCHEMA유형</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">그래프 구축 완료, 다음 단계로 진입하여 시뮬레이션 환경을 구성하세요</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? '생성 중...' : '환경 구성 진입 ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// 환경 구성 진입 - simulation 생성 후 이동
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('프로젝트 또는 그래프 정보 부족')
    return
  }
